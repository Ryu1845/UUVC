...
parser.add_argument(
    "--vocoder_config_path", type=str, default="vocoder/cp_hifigan/config.json"
)
parser.add_argument(
    "--vocoder_ckpt_path", type=str, default="vocoder/cp_hifigan/g_02500000"
)
...
checkpoint_callback = ModelCheckpoint(
    ...
    every_n_epochs=(
        None if args.check_val_every_n_epoch == 1 else args.check_val_every_n_epoch
    ),
    verbose=True,
    save_last=True,
)
